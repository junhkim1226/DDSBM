...
from ddsbm.models.layers import Etoy, Xtoy, masked_softmax
...
class GraphTransformer(nn.Module):
    ...
    def forward(self, X, E, X_T, E_T, y, y_T, node_mask):
        bs, n = X.shape[0], X.shape[1]  # X : (bs, n, d)
