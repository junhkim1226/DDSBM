...
from ddsbm.diffusion import diffusion_utils, distributions
...
class Comm20Dataset(InMemoryDataset):
    def __init__(
        self,
        stage,
        root,
...
class Comm20infos(AbstractDatasetInfos):
