...
class ExtraFeatures:
    def __init__(self, extra_features_type, dataset_info):
        self.max_num_nodes = dataset_info.max_num_nodes
    ...
    # TODO : Check extra feature
    def __call__(self, noisy_data):
        return self.__implicit_call__(noisy_data)

    def __implicit_call__(self, noisy_data):
        n = noisy_data["node_mask"].sum(dim=1).unsqueeze(1) / self.max_num_nodes
