...
class SamplingMolecularMetrics(nn.Module):
    def __init__(self, dataset_infos, train_smiles):
        super().__init__()
        di = dataset_infos
        self.generated_n_dist = GeneratedNDistribution(di.max_num_nodes)
        ...
        self.generated_valency_dist = ValencyDistribution(di.max_num_nodes)
    ...
    def forward(
        ...
        return stability, rdkit_metrics, all_smiles
